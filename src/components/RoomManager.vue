...
<template>
  <div class="min-h-screen bg-gradient-to-br from-orange-50 via-white to-orange-100">
    <RoomForm @room-created="handleRoomSubmit" @show-toast="showToast" />
    
    <div v-if="rooms.length > 0" class="max-w-4xl mx-auto p-6 mt-8">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        >
            ...
            <div class="flex items-center justify-between">
              ...
              <div class="flex items-center gap-2">
                ...
                <button
                  ...
                  class="h-8 w-8 text-red-500 hover:text-red-700 hover:bg-red-50 rounded border border-gray-300 flex items-center justify-center transition-colors"
                >
          ...
          <div class="px-6 pb-6 space-y-3">
            ...
            <div v-if="room.recursos.length > 0" class="mt-3">
...
export default {
  ...
  methods: {
    ...
    handleRemoveRoom(roomId, roomName) {
